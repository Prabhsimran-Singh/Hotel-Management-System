                 ...
                 <div class="row">
                     <div class="col-md-12">
                         ...
                         <div class="panel-body" >
                             ...
                             <form role="form" action="typeaddcode.php" method="post" enctype="multipart/form-data">
                                 <div class="form-group">
                                     <label>Type Name</label>
                                     <input class="form-control" name="typename" placeholder="Type Name"/>
                                 </div>
                                 <div class="form-group ">
                                     <label>Type Charges</label><br>
                                           <input  class="form-control" name="typecharges"  placeholder="$ TypeChargess (Doller)" />
                                 </div>
                                 <div class="form-group"> 
